#fix the code
#The issue is that we must change 'private' to 'protected' in the Employee
#class, because we want instances to be able to access serial_number, but still
#don't want it accessible anywhere else.
